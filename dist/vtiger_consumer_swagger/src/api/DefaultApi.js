...
(function (root, factory) {
  ...
  var exports = function exports(apiClient) {
    ...
    this.operationcreateContactPost = function (sessionName, cElement, message, callback) {
      ...
      return this.apiClient.callApi('/?operation=create_contact', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
    };
